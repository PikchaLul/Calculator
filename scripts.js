...
const allClearButton = document.getElementById('delete-all');
const previousOperandTextElement = document.getElementById('previous-value');
const currentOperandTextElement = document.getElementById('current-value');
